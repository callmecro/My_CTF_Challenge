...
HOME = "/home/user"
VULER = "com.wmctf.babyandroid"
ATTACKER = "com.wmctf.exploit"
...
def adb_activity(activity, extras=None):
...
with open(FLAG_FILE, "r") as f:
    adb_broadcast(f"{VULER}.SET_FLAG", f"{VULER}/.FlagReceiver", extras={"flag": f.read()})

time.sleep(3)
adb_install(EXP_FILE)
adb_grant(ATTACKER, "android.permission.READ_EXTERNAL_STORAGE")
adb_grant(ATTACKER, "android.permission.WRITE_EXTERNAL_STORAGE")
